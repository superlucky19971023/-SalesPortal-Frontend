...
import AddCustomerDrawer, { initialFormData } from "./add_customer";
...
const CustomListTable = ({ resData }) => {
      ...
      columnHelper.accessor("action", {
        ...
        cell: ({ row }) => (
          <div className="flex items-center">
            ...
            <IconButton>
              <i className="tabler-eye text-[22px] text-textSecondary" onClick={() => setOpen(true)} />
            </IconButton>
            <OptionMenu
  ...
  useEffect(() => {
    const filteredData = resData?.filter((invoice) => {
      if (
        status &&
