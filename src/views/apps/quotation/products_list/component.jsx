                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div>
                    <Typography color="text.primary">
                      This is field of products list
                    </Typography>
                  </div>
                </div>
              </div>
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12}>
              <Grid container spacing={2}>
                <Grid item xs={3}>
                  <SimpleTreeView>
                    <TreeItem itemId="Category 1" label="Category 1">
                      <TreeItem itemId="Category 1-1" label="Category 1-1" />
                      <TreeItem itemId="Category 1-2" label="Category 1-2" />
                      <TreeItem itemId="Category 1-3" label="Category 1-3" />
                    </TreeItem>
                    <TreeItem itemId="Category 2" label="Category 2">
                      <TreeItem itemId="Category 2-1" label="Category 2-1" />
                      <TreeItem itemId="Category 2-2" label="Category 2-2" />
                      <TreeItem itemId="Category 2-3" label="Category 2-3" />
                    </TreeItem>
                    <TreeItem itemId="Category 3" label="Category 3">
                      <TreeItem itemId="Category 3-1" label="Category 3-1" />
                      <TreeItem itemId="Category 3-2" label="Category 3-2" />
                      <TreeItem itemId="Category 3-3" label="Category 3-3" />
                    </TreeItem>
                    <TreeItem itemId="Category 4" label="Category 4">
                      <TreeItem itemId="Category 4-1" label="Category 4-1" />
                      <TreeItem itemId="Category 4-2" label="Category 4-2" />
                      <TreeItem itemId="Category 4-3" label="Category 4-3" />
                    </TreeItem>
                  </SimpleTreeView>
                </Grid>
                <Grid item xs={9}>
